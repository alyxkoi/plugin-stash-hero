...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "A curated vault of pro-tier plugins, instruments, and sample libraries. Instant access. Yours forever." },
      { name: "author", content: "Plugin Warehouse" },
      { property: "og:title", content: "Plugin Warehouse — Pro plugins at a fraction of the price" },
      { property: "og:description", content: "A curated vault of pro-tier plugins, instruments, and sample libraries. Instant access. Yours forever." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Plugin Warehouse — Pro plugins at a fraction of the price" },
      { name: "twitter:description", content: "A curated vault of pro-tier plugins, instruments, and sample libraries. Instant access. Yours forever." },
